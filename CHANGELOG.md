...
### Fixed
- **Bloque E de la auditoría 2026-07-31 — 10 de 12 ítems** (`docs/audit-2026-07-31.md`), casi todos del tipo "el bot queda inutilizable hasta `/reset`" o "se pierde algo que el usuario escribió":
